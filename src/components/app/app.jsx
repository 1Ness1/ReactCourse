...
class App extends Component {
    ...
    render() {
        ...
        const allEmployeesToEncrease = this.state.data.filter(item => item.increase).length;
        ...
        return (
            <div className='app'>
                ...
                <div className='search-panel'>
                    ...
                    <AppFilter onFilterSelect={this.onFilterSelect} filter={filter} visibleAllData={this.visibleAllData} />
                    <EmployeersList
